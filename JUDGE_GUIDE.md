...
| --------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| 0:00–0:10 | Show the five-case incident ledger and open the critical endpoint case.                                    | Tier 1 escalated a cross-domain chain; this is not a raw alert feed.                                                            |
| 0:10–0:22 | Show the Tier 1 handoff and select `invoice-sync-helper.exe`.                                              | Tier 1 supplied observations and evidence gaps but withheld response.                                                           |
| 0:22–0:42 | Copilot calls `get_case_context`, prepares `QRY-ENDPOINT-FILE-01`, and runs the visible KQL.               | WebMCP exposes a semantic investigation operation, not a click macro.                                                           |
| 0:42–0:55 | Open raw records and focus one record on the graph.                                                        | The result is auditable source data, not only an AI summary.                                                                    |
| 0:55–1:08 | Copilot prepares and runs `QRY-ENDPOINT-HASH-10`; then completes host, identity, and destination checks.   | Exact hash intelligence and control readiness support the decision.                                                             |
| 1:08–1:22 | Analyst releases the next observation; copilot runs `QRY-ENDPOINT-APP-05`.                                 | APP-SRV-021 blocked remote service start before payload execution.                                                              |
| 1:22–1:34 | Analyst records **Confirm malicious · contain**.                                                           | The disposition remains a human decision.                                                                                       |
| 1:34–1:47 | Copilot calculates exposure and simulates the allowlisted control.                                         | Observed activity and modeled reach remain visibly different.                                                                   |
| 1:47–2:04 | Copilot prepares the containment package. Analyst reviews and approves it.                                 | Forensic triage, endpoint isolation, exact-IP blocking, and identity disablement are human-gated; no external control executes. |
| 2:04–2:18 | Copilot requests recovery evidence. Analyst releases it. Copilot attaches credential and workload results. | The case can continue after containment without inventing a deployment.                                                         |
| 2:18–2:32 | Copilot prepares recovery. Analyst approves rotation and known-good redeploy records.                      | Recovery is dependency-ordered and auditable.                                                                                   |
| 2:32–2:50 | Copilot generates the evidence report.                                                                     | Show findings, response provenance, evidence references, limitations, and residual risk.                                        |
| 2:50–3:00 | Analyst approves closure and returns to the ledger.                                                        | The case ends at a human gate; the ledger proves scenario breadth.                                                              |
