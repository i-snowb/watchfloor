...
export const cloudIdentityScenario = {
  ...
  joins: [
    {
      ...
      label: "Identity authenticated as federated session",
    ...
    },
    {
      ...
      label: "Federated session assumed prod-admin",
    ...
    },
    {
      ...
      label: "prod-admin read production credential",
    ...
    },
    {
      ...
      label: "prod-admin accessed restricted export",
  ...
  presentation: {
    ...
    nodes: [
      ...
      { entityId: "indicator:198.51.100.24", x: 330, y: 410, lane: "entry" },
      { entityId: "role:prod-admin", x: 620, y: 190, lane: "access" },
      { entityId: "object:customer-export", x: 940, y: 70, lane: "impact" },
      { entityId: "secret:prod-db-primary", x: 940, y: 370, lane: "impact" },
    ],
    stageQuestions: [
