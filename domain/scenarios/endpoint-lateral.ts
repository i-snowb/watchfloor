...
export const endpointLateralScenario = {
  ...
  impact: {
    ...
    threatOverlay: {
      issues: [
        {
          id: "ISSUE-LAT-EXECUTION-SOURCE",
          rank: 1,
          entityId: "endpoint:fin-ws-044",
          severity: "critical",
          certainty: "observed",
          title: "Execution source",
          detail: "Unsigned zero-prevalence helper executed on the workstation",
          requiresStageId: null,
          requiresReachability: false,
        },
        {
          id: "ISSUE-LAT-IDENTITY-ABUSE",
          rank: 2,
          entityId: "identity:svc-fin-reports",
          severity: "high",
          certainty: "observed",
          title: "Service identity misuse",
          detail: "Out-of-scope logon and production credential access",
          requiresStageId: null,
          requiresReachability: false,
        },
        {
          id: "ISSUE-LAT-CREDENTIAL-READ",
          rank: 3,
          entityId: "secret:ci-deploy-token",
          severity: "high",
          certainty: "observed",
          title: "Production credential read",
          detail: "Deployment credential accessed by the service identity",
          requiresStageId: null,
          requiresReachability: false,
        },
        {
          id: "ISSUE-LAT-PREVENTED-TARGET",
          rank: 4,
          entityId: "endpoint:app-srv-021",
          severity: "guarded",
          certainty: "prevented",
          title: "Lateral execution prevented",
          detail: "Authentication succeeded; remote service start was blocked",
          requiresStageId: "STREAM-LAT-01",
          requiresReachability: false,
        },
        {
          id: "ISSUE-LAT-MODELED-WORKLOAD",
          rank: 5,
          entityId: "workload:billing-api",
          severity: "modeled",
          certainty: "modeled",
          title: "Potential workload impact",
          detail: "Reachable through the credential; no deployment observed",
          requiresStageId: null,
          requiresReachability: true,
        },
      ],
      priorityRoute: {
        id: "ROUTE-LAT-PRIORITY-01",
        title: "Highest potential consequence",
        detail:
          "billing-api reachable through the exposed production deployment credential",
        entityIds: [
          "endpoint:fin-ws-044",
          "identity:svc-fin-reports",
          "secret:ci-deploy-token",
        ...
        pathIds: ["PATH-LAT-01", "PATH-LAT-03", "PATH-LAT-04"],
        joinIds: ["JOIN-LAT-03", "JOIN-LAT-05", "JOIN-LAT-07"],
      },
    },
    initialHeadline:
